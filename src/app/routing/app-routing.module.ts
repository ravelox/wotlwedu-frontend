...
const routes: Routes = [
    ...
    {path: 'elections', resolve: { elections: electionDataResolver}, component: ElectionComponent, canActivate: [AuthGuard,AdminGuard]},
    {path: 'votes', resolve: { votes: voteDataResolver}, component: VoteComponent, canActivate: [AuthGuard]},
